        ...
        >
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 bg-accent text-accent-foreground px-8 py-3 font-bold text-sm tracking-wider hover:bg-gold-dark transition-colors"
            >
              تسوق الآن
            </motion.button>
          </div>
        ...
        {banners.map((_, i) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-all ${
              i === current ? "bg-accent w-8" : "bg-cream/50"
            }`}
          />
        ))}
      </div>
